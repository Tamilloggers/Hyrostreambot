...
from WebStreamer import config_dict, multi_clients, work_loads
...
@StreamBot.on_message(filters.command("status") & filters.private & filters.user(config_dict['OWNER_ID']))
...
@StreamBot.on_message(filters.command("ban") & filters.private & filters.user(config_dict['OWNER_ID']))
...
@StreamBot.on_message(filters.command("unban") & filters.private & filters.user(config_dict['OWNER_ID']))
async def sts(b, m: Message):
    usr_cmd = m.text.split()
    if len(usr_cmd) < 2:
...
@StreamBot.on_message(filters.command("broadcast") & filters.private & filters.user(config_dict['OWNER_ID']) & filters.reply)
...
@StreamBot.on_message(filters.command("who") & filters.private & filters.user(config_dict['OWNER_ID']) & filters.reply)
async def sts(c: Client, m: Message):
...
@StreamBot.on_message(filters.command("stats") & filters.private & filters.user(config_dict['OWNER_ID']))
