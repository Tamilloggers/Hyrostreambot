...
from WebStreamer import config_dict, multi_clients
...
async def send_message_with_error_handling(c: Client, chat_id, text, **kwargs):
    try:
        ...
        await c.send_message(config_dict['BIN_CHANNEL'], f"Admin rights required to send in this chat ({chat_id}).")
    except ChatWriteForbidden:
        await c.send_message(config_dict['BIN_CHANNEL'], f"Write permission required to send in this chat ({chat_id}).")
...
async def private_receive_handler(bot: Client, message: Message):
    ...
    try:
        ...
        await bot.send_message(
            chat_id=config_dict['BIN_CHANNEL'],
